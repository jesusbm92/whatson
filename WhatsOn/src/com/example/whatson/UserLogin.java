...
public class UserLogin extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		login.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				DoPOST mDoPOST = new DoPOST(UserLogin.this, user.getText()
						.toString());
	...
	public void launchUserView(View view) {
	...
	private class DoPOST extends AsyncTask<String, Void, Boolean> {
		...
		String userToSearch = "";
		String ip = "10.0.2.2";
		String ip2 = UserLogin.this.getString(R.string.ip);
		// Result data
		String userres;
		String passres;
