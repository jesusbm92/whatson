...
public class ConfirmDeleteAnnouncer extends Activity {
	private Button yes;
	private Button no;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		yes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				DoPOSTBorrar d = new DoPOSTBorrar(ConfirmDeleteAnnouncer.this,
	...
	private class DoPOSTBorrar extends AsyncTask<String, Void, Boolean> {
		...
		String user = "";
		String ip = "10.0.2.2";
		String ip2 = ConfirmDeleteAnnouncer.this.getString(R.string.ip);
		...
		protected Boolean doInBackground(String... arg0) {
			...
			try {
				...
				HttpPost httppost = new HttpPost("http://" + ip2
						+ "/clientservertest/borrarAnunciante.php");
		...
		protected void onPostExecute(Boolean valid) {
			...
			if (exception != null) {
				...
				AlertDialog msj = new AlertDialog.Builder(ConfirmDeleteAnnouncer.this).create();
				msj.setTitle("Error");
				msj.setMessage("No pudo borrarse el anunciante, intente de nuevo");
				msj.show();
			}
