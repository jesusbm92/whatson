...
public class ListAnnouncers extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		DoPOST doPost = new DoPOST(ListAnnouncers.this);
		doPost.execute();
	...
	protected void onResume() {
		...
		super.onResume();
		listaUsuarios.clear();
		setListAdapter(new ArrayAdapter<String>(ListAnnouncers.this,
	...
	private class DoPOST extends AsyncTask<String, Void, Boolean> {
		...
		String ip = "10.0.2.2";
		String ip2 = ListAnnouncers.this.getString(R.string.ip);
		...
		protected Boolean doInBackground(String... arg0) {
			...
			try {
				...
				HttpPost httppost = new HttpPost("http://" + ip2
						+ "/clientservertest/listaAnunciantes.php");
		...
		protected void onPostExecute(Boolean valid) {
			...
			if (exception != null) {
				...
				AlertDialog msj = new AlertDialog.Builder(ListAnnouncers.this).create();
				msj.setTitle("Error");
				msj.setMessage("No se pudo cargar la lista de anunciantes, intente de nuevo");
				msj.show();
			}
